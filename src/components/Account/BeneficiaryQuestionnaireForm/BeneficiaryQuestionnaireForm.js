...
export function BeneficiaryQuestionnaireForm(props) {
    ...
    const [isCheckedElectrodomesticos, setCheckedElectrodomesticos] = useState(false);
    ...
    const changeElectrodomesticos = () => {
        setCheckedElectrodomesticos((isCheckedElectrodomesticos) => !isCheckedElectrodomesticos);
        ...
        <View style={styles.contentAdentro} >
            ...
            <View style={{flex: 1, flexDirection: "row"}} >
                ...
                <View style={styles.sectionElectrodomesticos}>
                    <Checkbox
                    style={styles.checkbox}
                    value={isCheckedElectrodomesticos}
            ...
            <View style={{flex: 1, flexDirection: "row", alignItems: 'center'}} >
                <RadioButton
                    ...
                    onPress={() => { formik.setFieldValue("ayuda", "yo") }}
                    />
            ...
            <View style={{flex: 1, flexDirection: "row", alignItems: 'center'}} >
                <RadioButton
                    ...
                    onPress={() => { formik.setFieldValue("ayuda", "familia") }}
                    />
                <Text>Mi familia y yo</Text>
            </View>
            <Input placeholder="Explique lo que le sucedio y sus necesidades" style={{marginTop: 10}} multiline={true} onChangeText={(text) => formik.setFieldValue("descripcion", text)} errorMessage={formik.errors.descripcion}/>
