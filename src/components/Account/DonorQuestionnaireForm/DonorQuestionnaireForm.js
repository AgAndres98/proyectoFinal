  ...
  return (
    <View style={styles.contentAdentro}>
      ...
      <View style={{ flex: 1, flexDirection: "row" }}>
        <Text style={styles.text}>Incendios</Text>
        <Input
      ...
      <View style={{ flex: 1, flexDirection: "row" }}>
        <Text style={styles.text}>Inundaciones</Text>
        <Input
          placeholder="Puntuación"
      ...
      <View style={{ flex: 1, flexDirection: "row" }}>
        <Text style={styles.text}>Tsunamis</Text>
        <Input
          placeholder="Puntuación"
      ...
      <View style={{ flex: 1, flexDirection: "row" }}>
        <Text style={styles.text}>Gente en situación de calle</Text>
        <Input
          placeholder="Puntuación"
      ...
      <Text style={styles.titulo}>
        Seleccione la opción que mas lo identifique
      </Text>
